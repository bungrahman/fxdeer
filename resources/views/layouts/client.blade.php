...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('favicon.png') }}?v=1">
    <link rel="icon" type="image/png" href="{{ asset('favicon.png') }}?v=1">
    <title>
        @yield('title') - FXDeer Client
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('client.dashboard') }}">
                ...
                <span class="ms-1 font-weight-bold">FXDeer Client</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('client.pipelines') ? 'active' : '' }}" href="{{ route('client.pipelines') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-settings text-warning text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">My Pipelines</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('client.billing') ? 'active' : '' }}" href="{{ route('client.billing') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Billing & Plans</span>
                    </a>
                </li>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Client</a></li>
