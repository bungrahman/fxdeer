    ...
    <form action="{{ route('admin.plans.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
                ...
                <input type="text" name="name" class="input-field" placeholder="e.g. Enterprise Elite" required>
            </div>
            <div>
                <label class="block text-gray-500 dark:text-[#94A3B8] text-sm mb-2">Monthly Price ($)</label>
                <input type="number" step="0.01" name="price" class="input-field" placeholder="99.00" required>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 2rem; margin-bottom: 2rem;">
            <div>
                ...
                <input type="number" name="max_alerts_per_day" class="input-field" placeholder="10" required>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
                ...
                <input type="text" name="tags" class="input-field" placeholder="forex,asia">
            </div>
            <div>
                <label class="block text-gray-500 dark:text-[#94A3B8] text-sm mb-2">HashTags</label>
                <input type="text" name="hashtags" class="input-field" placeholder="#fxdeer #fxnews">
            </div>
        </div>
        ...
        <input type="hidden" name="channels_allowed[]" value="telegram">
        ...
        <button type="submit" style="width: 100%; background: #FF2D20; color: white; padding: 1.2rem; border-radius: 12px; border: none; font-weight: 700; font-size: 1rem; cursor: pointer; transition: all 0.2s;">Create Subscription Plan</button>
    </form>
</div>
@endsection
